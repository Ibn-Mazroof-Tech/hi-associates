...
export type Service = {
  ...
  // Optional short callout shown on the service detail page — e.g. a
  // regional restriction. Keep it to one sentence.
  note?: string;
};
...
export const services: Service[] = [
  ...
  },
  {
    ...
    title: "Birth Certificate (Name Inclusion / Correction)",
    shortDesc:
      "Add or correct a name on a birth certificate — currently available for Delhi only.",
    fullDesc:
      "If a name was left out or recorded incorrectly on a birth certificate, we help you get it added or corrected through the concerned Municipal Corporation / Registrar of Births & Deaths office. This service is currently available for Delhi records only.",
    icon: "Baby",
    note: "This service is currently available for Delhi records only.",
    documentsRequired: [
      "Original birth certificate (if already issued)",
      "Hospital birth record / discharge slip, if available",
      "Identity proof of parents (Aadhaar / PAN)",
      "Address proof",
      "Affidavit for name inclusion or correction",
    ],
    processingTime: "2–4 weeks (Delhi records only)",
  },
  {
    slug: "newspaper-advertising",
    title: "Newspaper Advertising",
    shortDesc:
      "Public notice and classified advertisements in local and national newspapers — often required alongside Gazette applications.",
    fullDesc:
      "Many government processes — including Gazette name change — require a public notice to be published in newspapers before the application can be filed. We handle the ad copy, newspaper selection, and publication on your behalf, and share the published copies for your records.",
    icon: "Newspaper",
    documentsRequired: [
      "Details of the notice to be published (name, reason, other specifics)",
      "Identity proof",
      "Address proof",
    ],
