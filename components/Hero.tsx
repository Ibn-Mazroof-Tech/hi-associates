...
export function Hero() {
  return (
    <section className="relative isolate overflow-hidden bg-[var(--color-ink)]">
      {/* Background image — replace /public/hero-office-desk.jpg with a
          real photo (office desk with Passport / PAN / Aadhaar / Gazette
          documents laid out). See README for sourcing suggestions. */}
      <Image
        src="/hero-office-desk.jpg"
        alt=""
        aria-hidden="true"
        fill
        priority
